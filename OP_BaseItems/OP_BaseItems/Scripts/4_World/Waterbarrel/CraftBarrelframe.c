class CraftBarrelframe extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Barrelframe";
		...
		//result1
		AddResult("Barrelframe");//add results here
...
class AttachWaterBarrel extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Attach Waterbarrel";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Waterbarrel");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"BarrelFrame");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Waterbarrelcomplete");//add results here
