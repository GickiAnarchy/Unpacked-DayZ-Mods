class Banner_Colorbase extends ItemBase
{
	void Banner_Colorbase()
	{
	}
	void ShowAttached()
	{
...
class OP_WoodlandBanner extends Banner_Colorbase {}
class OP_UCPBanner extends Banner_Colorbase {}
class OP_CamoNetNatoBanner extends Banner_Colorbase {}
class OP_CamoNetEastBanner extends Banner_Colorbase {}
...
class CraftCamoEBanner extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft CamoEast Banner";
		...
		//ingredient 2
		InsertIngredient(1,"CamoNet");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("OP_CamoNetEastBanner");//add results here
...
class CraftCamoNBanner extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft CamoNato Banner";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("OP_CamoNetNatoBanner");//add results here
...
class CraftCamoUCPBanner extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft UCP Camo Banner";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("OP_UCPBanner");//add results here
...
class CraftCamoWoodBanner extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Woodland Camo Banner";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("OP_WoodlandBanner");//add results here
...
class CraftBannerMount extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft BannerMount";
		...
		//result1
		AddResult("OP_BannerMount");//add results here
