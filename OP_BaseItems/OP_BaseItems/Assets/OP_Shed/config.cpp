////////////////////////////////////////////////////////////////////
//DeRap: OP_BaseItems\Assets\OP_Shed\config.bin
//Produced from mikero's Dos Tools Dll version 7.89
//https://mikero.bytex.digital/Downloads
//'now' is Tue Jan 12 10:46:18 2021 : 'file' last modified on Thu Nov 19 09:23:16 2020
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class OP_Shed
	{
		units[] = {"OP_Shed","OP_Shed2","OP_ShedKitProjection","OP_ShedKit"};
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Structures_Military","DZ_Gear_Crafting","DZ_Gear_Consumables"};
	};
};
class CfgVehicles
{
	...
	class OP_Shed: Inventory_Base
	{
		scope = 2;
		displayName = "Wooden Shed";
		descriptionShort = "A shed from the mod OP_Baseitems.";
		model = "\OP_Baseitems\Assets\OP_Shed\OP_Shed.p3d";
	...
	class OP_Shed2: OP_Shed{};
	class OP_ShedKitProjection: Inventory_Base
	{
		scope = 2;
		displayName = "Shed Kit";
		descriptionShort = "Used to build a shed from OP_Baseitems";
		model = "\OP_Baseitems\Assets\OP_Shed\OP_ShedkitPlacing.p3d";
	};
	class OP_ShedKit: Inventory_Base
	{
		scope = 2;
		displayName = "Shed Kit";
		descriptionShort = "Used to build a shed from OP_Baseitems";
		model = "\OP_Baseitems\Assets\OP_Shed\op_shedkit_hands.p3d";
		rotationFlags = 17;
		itemSize[] = {1,5};
		weight = 280;
		itemBehaviour = 1;
