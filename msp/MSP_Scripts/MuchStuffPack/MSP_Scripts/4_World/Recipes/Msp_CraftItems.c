class Msp_CraftItems extends RecipeBase
{	
	string name = "Craft";
    bool canDo = true;
	...
	void Msp_CraftItems(Msp_ItemRecipeValues recipeValues)
	{		
	...
	void Setup(Msp_ItemRecipeValues recipeValues)
	{
		name = recipeValues.g_name;
		canDo = recipeValues.g_CanDo;
