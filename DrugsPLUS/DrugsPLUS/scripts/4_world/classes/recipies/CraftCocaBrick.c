class DP_CraftCocaBrick extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Coca Brick";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"DP_CocaBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DP_CocaBrick");//add results here
